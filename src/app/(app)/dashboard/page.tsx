...
function getGreeting(): string {
	...
	if (h < GreetingThresholds.night) return GreetingMessages.night;
	if (h < GreetingThresholds.morning) return GreetingMessages.morning;
	if (h < GreetingThresholds.afternoon) return GreetingMessages.afternoon;
	return GreetingMessages.evening;
}
					...
					<div
						...
						<div
							...
							{detailModal.type === "stock" &&
								(() => {
									const p =
										detailModal.data as ProductWithStock;
									return (
										<div
											style={{
												display: "flex",
									...
									return (
										<div
											...
											<div
												...
												<span
													className={`badge badge-${c.status === "permanent" ? "success" : c.status === "récurrent" ? "primary" : c.status === "inactif" ? "danger" : "light"}`}
													style={{
														marginLeft: "auto",
													}}>
													{c.status}
									...
									return (
										<div
											...
											<div
												...
												<span
													className={`badge ${s.status === "completed" ? "badge-success" : s.status === "cancelled" ? "badge-danger" : "badge-warning"}`}>
													{s.status === "completed"
														? "Finalisée"
														: s.status ===
															  "cancelled"
