...
const KANBAN_COLUMNS = [
	{ key: "en_attente", label: "A faire", color: "#95a5a6" },
	{ key: "en_cours", label: "En cours", color: "var(--accent)" },
	{ key: "bloquee", label: "Bloquee", color: "var(--danger)" },
	{ key: "realisee", label: "Termine", color: "var(--success)" },
];
									...
									<div
										...
										<div
											...
											<div
												...
												{p.priority && (
													<span
														className={`badge ${PRIORITY_BADGE[p.priority] || "badge-light"}`}
														style={{
															fontSize: "0.65rem",
														}}>
														{PRIORITY_LABEL[
								...
								<div style={{ flex: 1, minWidth: 0 }}>
									...
									<div
										...
										{selectedProject.priority && (
											<span
												className={`badge ${PRIORITY_BADGE[selectedProject.priority] || "badge-light"}`}
												style={{
													fontSize: "0.68rem",
												}}>
												{PRIORITY_LABEL[
																...
																(t) => (
																	<div
																		...
																		style={{
																			...
																			borderRadius:
																				"8px",
																			borderLeft: `3px solid ${TASK_STATUS_COLOR[t.status] || "#95a5a6"}`,
																		}}>
																		<span
																		...
																		<span
																			className={`badge ${PRIORITY_BADGE[t.priority] || "badge-light"}`}
																			style={{
																				fontSize:
																					"0.62rem",
																				flexShrink: 0,
